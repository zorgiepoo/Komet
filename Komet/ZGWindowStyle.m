...
- (instancetype)initWithBarColor:(NSColor *)barColor barTextColor:(NSColor *)barTextColor dividerLineColor:(NSColor *)dividerLineColor appearance:(NSAppearance *)appearance textColor:(NSColor *)textColor textHighlightColor:(NSColor * _Nullable)textHighlightColor commentColor:(NSColor *)commentColor overflowColor:(NSColor *)overflowColor fallbackBackgroundColor:(NSColor *)fallbackBackgroundColor scrollerKnobStyle:(NSScrollerKnobStyle)scrollerKnobStyle
{
	self = [super init];
	if (self != nil)
	{
